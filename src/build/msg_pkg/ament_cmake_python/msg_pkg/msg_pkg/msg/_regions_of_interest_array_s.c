...
bool msg_pkg__msg__regions_of_interest_array__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("msg_pkg.msg._regions_of_interest_array.RegionsOfInterestArray", full_classname_dest, 61) == 0);
  }
  msg_pkg__msg__RegionsOfInterestArray * ros_message = _ros_message;
  {  // regions
...
{
  /* NOTE(esteve): Call constructor of RegionsOfInterestArray */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("msg_pkg.msg._regions_of_interest_array");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RegionsOfInterestArray");
