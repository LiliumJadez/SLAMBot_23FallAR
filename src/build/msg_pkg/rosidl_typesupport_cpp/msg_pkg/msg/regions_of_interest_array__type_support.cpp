...
static const _RegionsOfInterestArray_type_support_symbol_names_t _RegionsOfInterestArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, msg_pkg, msg, RegionsOfInterestArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, msg_pkg, msg, RegionsOfInterestArray)),
  }
};
...
{
  return &::msg_pkg::msg::rosidl_typesupport_cpp::RegionsOfInterestArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, msg_pkg, msg, RegionsOfInterestArray)() {
  return get_message_type_support_handle<msg_pkg::msg::RegionsOfInterestArray>();
}
